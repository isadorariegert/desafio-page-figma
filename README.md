...
### Algumas Explicacoes sobre a landing page:

- A pagina foi criada segundo um layout disponivel no FIGMA enviado pela propria empresa:
...
- Apesar do layout proposto ser enviado numa scren 1440, apliquei o estilo seguindo MobileFirst por se tratar de uma pratica da empresa;
...
- Introduzi os breakpoins/media queries no decorrer do codigo CSS, pois essa e' a forma que eu considero mais facil leitura/manutencao;
